...
public:
    ...
    void setupUi(QWidget *choose)
    {
        ...
        saving = new QPushButton(choose);
        saving->setObjectName("saving");
        saving->setGeometry(QRect(60, 170, 56, 18));
        unsaving = new QPushButton(choose);
        unsaving->setObjectName("unsaving");
        unsaving->setGeometry(QRect(200, 170, 56, 18));
    ...
    void retranslateUi(QWidget *choose)
    {
        ...
        saving->setText(QCoreApplication::translate("choose", "\344\277\235\345\255\230", nullptr));
        unsaving->setText(QCoreApplication::translate("choose", "\344\270\215\344\277\235\345\255\230", nullptr));
